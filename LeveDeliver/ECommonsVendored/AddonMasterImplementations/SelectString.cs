...
public partial class AddonMaster
{
    public unsafe class SelectString : AddonMasterBase<AddonSelectString>
    {
        ...
        public SeString SeString => Dalamud.Memory.MemoryHelper.ReadSeStringNullTerminated((IntPtr)(&Base->GetTextNodeById(2)->NodeText));
        public string Text => SeString.ToString();
        ...
        public struct Entry(SelectString am, AddonSelectString* addon, int index)
        {
            ...
            public readonly string Text => SeString.ToString();
